  ...
  <div class="bg-white py-16 sm:py-24">
    <div class="relative sm:py-16">
      <div aria-hidden="true" class="hidden sm:block">
        <div class="absolute inset-y-0 left-0 w-1/2 bg-primary-50 rounded-r-3xl" />
        <svg
      ...
      <Container>
        <div
          class="relative rounded-2xl px-6 py-10 bg-gradient-to-b from-primary-100 to-primary-200 overflow-hidden shadow-xl sm:px-12 sm:py-20"
        >
          <div aria-hidden="true" class="absolute inset-0 -mt-72 sm:-mt-32 md:mt-0">
            ...
            >
              <path
                class="text-secondary-100 text-opacity-40"
                fill="currentColor"
