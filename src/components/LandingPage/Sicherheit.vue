...
<template>
    ...
    <h2 class="text-4xl lg:text-5xl font-semibold mb-8 lg:mb-2 lg:mt-8 py-12">
    ...
    <div class="lg:grid lg:grid-cols-2 gap-8">
        <div class="flex flex-col gap-8 lg:order-2">
            ...
            <div class="grid gap-8 sm:grid-cols-2">
                ...
                <div v-for="(feature, index) in features" :key="index" class="rounded-lg bg-gray-50 px-6 py-3 grid gap-2"
