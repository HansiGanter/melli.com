          ...
          <form id="sib-form" method="POST" action="https://ccfae1fd.sibforms.com/serve/MUIEAL3l5-FytLZ2MAonfnwnT33ih4jXcwYFJ0D4EK9EmgK_-_BjyuRJ4gJveKQ-ES-hTAdOzVx-2tr5FEobA_oTjLNUcVVG8_fNlm5YqbCe9D5qjDtVDRiyiymxs2bvE177aSjKSSkJxEt7PEoXmpnSXjwyTYn1g35LqARCIr-nJbVWlHsqDvWGwX6vYC6VSWJBd1yfTi8xmfvk" data-type="subscription" @submit="fireCallbackSentEvent()">
            ...
            <div style="padding: 8px 0;">
              <div class="sib-form-block" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent; text-align:left">
                <div class="sib-text-form-block">
                  <p>Gerne klären wir all deine Fragen rund um Melli telefonisch mit dir. Um dich zu kontaktieren, benötigen wir lediglich die unten stehenden Informationen.</p>
                </div>
              </div>
            </div>
            <div style="padding: 8px 0;">
            ...
            <div style="padding: 8px 0;">
              <div class="sib-input sib-form-block">
                <div class="form__entry entry_block">
                  <div class="form__label-row ">
                    <label class="entry__label" style="font-weight: 700; text-align:left; font-size:16px; text-align:left; font-weight:700; font-family:&quot;Helvetica&quot;, sans-serif; color:#3c4858;" for="TELEFONNUMMER" data-required="*">Telefonnummer</label>
            ...
            <div style="padding: 8px 0;">
              <div class="sib-input sib-form-block">
                <div class="form__entry entry_block">
                  <div class="form__label-row ">
                    <label class="entry__label" style="font-weight: 700; text-align:left; font-size:16px; text-align:left; font-weight:700; font-family:&quot;Helvetica&quot;, sans-serif; color:#3c4858;" for="FREIFELD" data-required="*">Wann bist du am besten erreichbar?</label>
                    ...
                    <div class="entry__choice" style="">
                      <label>
                        ...
                        <span
                          ...
                          style="margin-left:"
                        /><span style="font-size:14px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent;"><p>Ich möchte von Melli.com telefonisch kontaktiert werden.</p><span data-required="*" style="display: inline;" class="entry__label entry__label_optin" /></span> </label>
                    </div>
                  </div>
                  <label class="entry__error entry__error--primary" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;" />
                </div>
                    ...
                    <div style="">
                      <div class="entry__choice">
                        <label class="checkbox__label">
                          <input type="checkbox" class="input_replaced" name="lists_32[]" data-value="Ich möchte den Newsletter von Melli.com erhalten und akzeptiere die Datenschutzbestimmungen." value="7" data-required="true">
                          <span
                            class="checkbox checkbox_tick_positive"
                            style="margin-left:"
                          /><span style="font-size:14px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent;">Ich möchte den Newsletter von Melli.com erhalten und akzeptiere die Datenschutzbestimmungen.</span> </label>
                      </div>
                    </div>
                  </div>
                  <label class="entry__error entry__error--primary" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;" />
