...
import { fireDipaFormOpenEvent, fireDipaFormSentEvent, fireScrollToDipaEvent } from '~/google-tag-manager';
    ...
    <div class="flex flex-col gap-8 bg-primary-900 py-6 sm:py-18 px-6 sm:px-12">
      <div class="flex flex-col gap-4">
        ...
        <p class="text-center text-lg font-normal text-white">
          Melli goes DiPA (digitale Pflegeanwendung). Melli könnte bald für viele Senioren kostenlos zur Verfügung stehen.
          Dafür brauchen wir dich! Bewirb jetzt deine Oma, Opa, Mutter, Vater als Melli-Tester und nehmt an unserer
          DiPA-Studie teil.
        </p>
      </div>
      <div>
        <form class="flex flex-col gap-8 bg-primary-900" method="get" @submit.prevent="submitFunction()">
          ...
          <div class="flex flex-col sm:flex-row md:flex-col lg:flex-row gap-3 mx-auto">
            ...
            <RouterLink to="#becomeTestUser"
              class="text-white border-white border-1.5 flex gap-2 items-center mx-auto px-4 py-2.5 rounded-lg w-fit text-center"
              @click="fireScrollToDipaEvent()">
                  ...
                  <div style="padding: 8px 0;">
                    <div class="sib-form-block"
                      ...
                      <div class="sib-text-form-block">
                        <p>Bewirb dich, deine Eltern oder Großeltern jetzt als Melli-Tester und hilf uns dabei Melli als
                          digitales Pflegemittel zu zertifizieren.</p>
                      </div>
                    </div>
                  </div>
                  <div style="padding: 8px 0;">
                      ...
                      <div class="form__entry entry_block">
                        <div class="form__label-row ">
                          ...
                          <div class="entry__field">
                            <input id="VORNAME" class="input " maxlength="200" type="text" name="VORNAME"
                              autocomplete="off" placeholder="Max" data-required="true" required>
                          </div>
                        </div>
                        ...
                        <div class="form__label-row ">
                          ...
                          <div class="entry__field">
                            <input id="NACHNAME" class="input " maxlength="200" type="text" name="NACHNAME"
                              autocomplete="off" placeholder="Mustermann" data-required="true" required>
                          </div>
                        </div>
                    ...
                    <div class="sib-radiobutton-group sib-form-block" data-required="true">
                      <div class="form__entry entry_mcq">
                        <div class="form__label-row ">
                          <label class="entry__label"
                            style="font-weight: 700; text-align:left; font-size:16px; text-align:left; font-weight:700; font-family:&quot;Helvetica&quot;, sans-serif; color:#3c4858;"
                            for="QUESTION_ROLE" data-required="*">Wen möchtest du als Melli-Tester bewerben?</label>
                          <div>
