...
<template>
  <div v-if="showBanner" class="flex p-2 bg-primary-700 rounded-b-2xl lg:rounded-b-3xl">
    <RouterLink to="/shop" class="flex gap-3 lg:gap-4 mx-auto" @click="fireShopEvent">

      <BubbleIcon :bubble-type="2" bubble="text-primary-900" icon="i-ph:heart w-12 h-12 sm:w-24 sm:h-24 text-#FACC15"
        class="m-auto" />
