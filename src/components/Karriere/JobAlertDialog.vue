...
<template>
  <Container class="py-5 sm:py-6 lg:py-8">
    <form class="layout_form cr_form cr_font max-w-lg" action="https://eu2.cleverreach.com/f/329911-336280/wcs/" method="post" target="_blank">
      <div class="cr_body cr_page cr_font formbox">
        <div class="non_sortable" style="text-align:left;" />
        <div class="editable_content grid gap-3" style="text-align:left;">
          <div id="7539498" rel="email" class="cr_form-component cr_form-component--email cr_ipe_item ui-sortable musthave">
            <div class="grid gap-1 cr_form-inputgroup--typeemail">
              <label for="text7539498">E-Mail-Adresse*</label>
              <input id="text7539498" class="cr_form-input" type="email" name="email" :value="email" placeholder="name@example.com">
            </div>
          </div>
          <div id="7539502" rel="text" class="cr_form-component cr_form-component--text cr_ipe_item ui-sortable musthave">
            <div class="grid gap-1 cr_form-inputgroup--typetext">
              <label for="cr_form-input--text7539502" class="itemname">Anrede*</label>
              <input id="cr_form-input--text7539502" class="cr_form-input" type="text" name="1011280" placeholder="">
            </div>
          </div>
          <div id="7539503" rel="text" class="cr_form-component cr_form-component--text cr_ipe_item ui-sortable musthave">
            <div class="grid gap-1 cr_form-inputgroup--typetext">
              <label for="cr_form-input--text7539503" class="itemname">Vorname*</label>
              <input id="cr_form-input--text7539503" class="cr_form-input" type="text" name="1011281" placeholder="">
            </div>
          </div>
          <div id="7539504" rel="text" class="cr_form-component cr_form-component--text cr_ipe_item ui-sortable musthave">
            <div class="grid gap-1 cr_form-inputgroup--typetext">
              <label for="cr_form-input--text7539504" class="itemname">Nachname*</label>
              <input id="cr_form-input--text7539504" class="cr_form-input" type="text" name="1011282" placeholder="">
            </div>
          </div>
          <div id="7539505" rel="checkbox" class="cr_form-component cr_form-component--group cr_form-component--checkbox cr_ipe_item ui-sortable musthave">
            <div class="cr_form-component--group">
              <!-- FIXME: Nebeneinander, nicht untereinander -->
              <span class="grid gap-1 cr_form-inputgroup--typecheckbox flex gap-2">
                <input id="17539505" class="cr_form-checkbox cr_ipe_checkbox" type="checkbox" name="1011283[]" value="1">
                <label for="17539505" class="label cr_form-component--header flex-1">Ich bin damit einverstanden, dass die meetap GmbH mir Informationen zu Stellenanzeigen per E-Mail zusendet. Die Einwilligung kann jederzeit mit Wirkung für die Zukunft widerrufen werden. Es gelten die AGB und Datenschutzrichtlinien.*</label>
              </span>&nbsp;
            </div>
          </div>
          <div id="7539500" rel="button" class="cr_form-component cr_form-component--submit cr_ipe_item ui-sortable  submit_container">
