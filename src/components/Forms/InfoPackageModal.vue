    ...
    <div id="success-message" class="hidden relative grid gap-8 p-8 sm:gap-12 sm:p-12 bg-primary-50">
      ...
      <div class="flex flex-col sm:flex-row gap-8 sm:gap-12">
        <div class="flex flex-col items-center gap-4">
          <BubbleIcon class="grow-none" bubble-type="1" bubble="h-14 w-14 text-primary-300"
        ...
        <div class="flex flex-col items-center gap-4">
          ...
          <span class="text-lg leading-relaxed text-center sm:text-start">Das Melli-Infopaket macht sich<br> auf den Weg
            zu
            dir.</span>
        </div>
      </div>
      ...
      <div id="sib-form-container" class="sib-form-container">
        ...
        <div id="sib-container" class="sib-container--large sib-container--vertical"
          ...
          <form id="sib-form" method="POST"
            action="https://ccfae1fd.sibforms.com/serve/MUIFABZrCMtpCGWlU9EKhH0QYZD6d41JKmY0oFSZdOEGGRWvcXF5cHZwMGxYlX8OZvQxuUkXaHYg5wIKZwCXuA8x_DoKr-zOK7f24AZAHEUmuZpRTyN0KJsYkf2TNeLnFGEpclJ-QTuRuQ5dnvuZG1zSOTnDQsUQO1Y2t1KhFR8VDLhlox9M-4MsRpYwBv-S90VVZYHTdU-STNZ4"
            ...
            <div style="padding: 8px 0;">
              <div class="sib-form-block"
                ...
                <p>Bestell jetzt dein kostenloses Melli Infopaket</p>
              </div>
            </div>
            <div style="padding: 8px 0; display: none;">
              <input id="INITIAL_REFERRER_URL" class="input " maxlength="200" type="text" name="INITIAL_REFERRER_URL"
                autocomplete="off" placeholder="INITIAL_REFERRER_URL">
              <input id="LAST_REFERRER_URL" class="input " maxlength="200" type="text" name="LAST_REFERRER_URL"
                autocomplete="off" placeholder="LAST_REFERRER_URL">
              ...
              <input id="UTM_TERM" class="input " maxlength="200" type="text" name="UTM_TERM" autocomplete="off"
                  ...
                  <div class="form__label-row ">
                    ...
                    <div class="entry__field">
                      <input class="input " maxlength="200" type="text" id="TELEFONNUMMER" name="TELEFONNUMMER"
                        autocomplete="off" placeholder="017012345678" />
                    </div>
                  </div>
            ...
            <div style="padding: 8px 0;">
              <div class="sib-form-block"
                ...
                <div class="sib-text-form-block">
                  <p>Die folgenden Informationen benötigen wir, um dir das Melli Infopaket per Post zuzuschicken.</p>
                </div>
              </div>
            </div>
            <div style="padding: 8px 0;">
              <div class="sib-input sib-form-block">
                <div class="form__entry entry_block">
                  <div class="form__label-row ">
                    <label class="entry__label"
                      style="font-weight: 700; text-align:left; font-size:16px; text-align:left; font-weight:700; font-family:&quot;Helvetica&quot;, sans-serif; color:#3c4858;"
                      for="STRASSE_HAUSNUMMER">Straße, Hausnummer</label>

                    <div class="entry__field">
                      <input class="input " maxlength="200" type="text" id="STRASSE_HAUSNUMMER" name="STRASSE_HAUSNUMMER"
                        autocomplete="off" placeholder="Musterstraße 12a" />
                    </div>
                  </div>
                      ...
                      <label>
                        ...
                        <span class="checkbox checkbox_tick_positive" style="margin-left:" /><span
                          ...
                          <p>Ich willige ein von melli - meetap GmbH unter der von mir angegebenen Nummer kontaktiert
                            ...
                            Datenschutzerklärung zur Kenntnis genommen.</p><span data-required="*"
            ...
            <div style="padding: 8px 0;">
              <div class="sib-form-block" style="text-align: left">
                <button class="sib-form-block__button sib-form-block__button-with-loader"
                  ...
                  form="sib-form" type="submit" @click="onSubmitClicked">
